...
$ipaddressdc1 = "192.168.111.139" # IP-address of DC1
...
$domainName = "Devious.sec" # replace with your domain name (e.g. InfraIT.sec)

$cred = Get-Credential -UserName "Migell@$domainName" -Message 'Provide credentials for a domain admin'
