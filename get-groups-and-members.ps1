...
$globalGroupsOU = "OU=Global,OU=Devious_Groups,DC=Devious,DC=sec"  # Add your Global Groups OU path here
$localGroupsOU = "OU=Local,OU=Devious_Groups,DC=Devious,DC=sec"   # Add your Local Groups OU path here
